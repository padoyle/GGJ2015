...
var	gScenarios = {
	...
	moa1: new Scenario("Upon accepting his offer, you've been whisked away to Mouselandia, where you're hailed as their new rulers.  You live happily ever after.", 
		"What bird we do now?", "images/moa1.jpg", "A mouse in a house"),
	moa2: new Scenario("Upon accepting his offer, you've been whisked away to Mouselandia, where you're hailed as their new rulers.  You live happily ever after.", 
...
var	gOps = {
	...
	acceptMouseOffer: new VoteOption("Just... just walk away...", gScenarios.mlend),
